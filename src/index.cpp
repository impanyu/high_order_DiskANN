                                          ...
                                          const tsl::robin_set<uint32_t> *const delete_set_ptr)
{
    ...
    */
   //float cur_alpha = 1;
    float cur_alpha = _indexingAlphas[0]+0.06;
    float cur_alpha2 = _indexingAlphas[1]+0.06;
    ...
    for(;cur_alpha>=std::max(1, _indexingAlphas[0]-0.06); cur_alpha = cur_alpha - 0.02){
        for(cur_alpha2 = _indexingAlphas[1]+0.06; cur_alpha2>=std::max(1,_indexingAlphas[1]-0.06) ; cur_alpha2 = cur_alpha2 - 0.02){
